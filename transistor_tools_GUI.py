...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(30, 70, 561, 61))
        ...
        self.groupBox.setGeometry(QtCore.QRect(60, 170, 509, 581))
        ...
        self.verticalLayoutWidget_3 = QtGui.QWidget(self.page_keithley)
        ...
        self.verticalLayoutWidget_4 = QtGui.QWidget(self.page_keithley)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 20, 421, 161))
        ...
        self.checkBox_3 = QtGui.QCheckBox(self.verticalLayoutWidget_4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_Measurement.setItemText(0, _translate("MainWindow", "Keithley Control", None))
        self.comboBox_Measurement.setItemText(1, _translate("MainWindow", "Deposition Control", None))
        self.comboBox_Measurement.setItemText(2, _translate("MainWindow", "Substrate Heating Control", None))
        ...
        self.checkBox.setText(_translate("MainWindow", "Take measurement between IV sweeps", None))
        ...
        self.checkBox_2.setAccessibleName(_translate("MainWindow", "SweepForward", None))
        self.checkBox_2.setText(_translate("MainWindow", "Forward Sweep", None))
        self.checkBox_3.setAccessibleName(_translate("MainWindow", "SweepReverse", None))
        self.checkBox_3.setText(_translate("MainWindow", "Reverse Sweep", None))
        self.doubleSpinBox_4.setAccessibleName(_translate("MainWindow", "Vtime", None))
        ...
        self.doubleSpinBox_3.setAccessibleName(_translate("MainWindow", "Vstep", None))
